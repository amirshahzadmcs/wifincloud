         ...
         <div class="navbar-collapse collapse" id="navbar-mobile">
            <ul class="nav navbar-nav">
               ...
               <?php if(isset($last_refresh)){ ?>
				<li>
					<a href="#"  data-popup="tooltip" title="" data-placement="right" id="fresh_data" data-original-title="Sync again">
						<i class="icon-sync"></i>
						Last updated: <?php echo date("j M - h:i A", strtotime($last_refresh));?>
					</a>
				</li>
				<?php } ?>
                <!-- <li class="dropdown">
