...
<section class="content genral-settion-container">
      ...
      <div class="col-sm-9">
         ...
         <div class="box">
            ...
            <div class="box-body">
               ...
               <div class="form-group">
                  <label for="formSetting-DateFormat">Date Format &nbsp; <a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-info-circle"></i></a></label>
                  <input type="text" class="form-control" name="date_format" id="formSetting-DateFormat" value="<?php echo setting('date_format') ?>" required placeholder="Enter Date Format" autofocus />
               </div>
               <div class="form-group">
                  <label for="formSetting-DateTimeFormat">DateTime Format &nbsp; <a href="#" data-toggle="modal" data-target="#myModal"><i class="fa fa-info-circle"></i></a> </label>
               ...
               <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="emails_to_send" id="emails_to_send" value="<?php echo setting('emails_to_send') ?>" required placeholder="example1@email.com, example2@email.com" />
               </div>
               <div class="form-group domain_expiry_email">
                  ...
                  <select class="form-control" name="domain_expiry_email">
                     <option value="weekly" <?php echo (isset($email_expiry) && $email_expiry == 'weekly') ? 'selected="selected"' : ''; ?>>weekly</option>
                        <option value="monthly"  <?php echo (isset($email_expiry) && $email_expiry == 'monthly') ? 'selected="selected"' : ''; ?> >Monthly</option>
                  </select>
               </div>
               <br>
               <h4>Google Recaptcha &nbsp; &nbsp; <input type="checkbox" value="ok" class="js-switch" name="google_recaptcha_enabled" onchange="recaptchKeysHideShow( $(this).is(':checked') )" <?php echo setting('google_recaptcha_enabled') == '1' ? 'checked' : '' ?> /> </h4>
               <hr>
               <div class="form-group recaptchKeysHideShow">
                  <label for="formSetting-DateTimeFormat">Site Key </label>
                  <input type="text" class="form-control" name="google_recaptcha_sitekey" id="formSetting-DateTimeFormat" value="<?php echo setting('google_recaptcha_sitekey') ?>" required placeholder="Site Key" autofocus />
               </div>
               <div class="form-group recaptchKeysHideShow">
                  <label for="formSetting-DateTimeFormat">Secret  Key </label>
                  <input type="text" class="form-control" name="google_recaptcha_secretkey" id="formSetting-DateTimeFormat" value="<?php echo setting('google_recaptcha_secretkey') ?>" required placeholder="Site Key" autofocus />
               </div>
            </div>
            <!-- /.box-body -->
