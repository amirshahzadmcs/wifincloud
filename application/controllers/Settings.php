...
class Settings extends MY_Controller {
	...
	public function general()
	{
		...
		$this->page_data['page']->menu = 'setting';
	...
	public function generalUpdate()
	{
		...
		$this->settings_model->updateByKey('emails_to_send', post('emails_to_send'));
		$this->settings_model->updateByKey('domain_expiry_email', post('domain_expiry_email'));
